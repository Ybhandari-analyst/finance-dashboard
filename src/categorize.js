export const CATEGORIES = [
  ...
  "Investments","Transfers","Refund / Credit","Card Fee","Other",
];
...
export const CAT_COLORS = {
  ...
  "Transfers":"#B4B2A9","Refund / Credit":"#5DCAA5","Card Fee":"#F09595","Other":"#B4B2A9",
};

export const EXPENSE_CATS = new Set([
  "Food Delivery","Dining & Drinks","Cannabis","Groceries","Shopping","Entertainment & Events",
  "Health & Wellness","Travel - Flights","Travel - Hotels","Transit & Rideshare",
  "Subscriptions & Apps","Bills & Utilities","Rent","Card Fee","Other",
]);
...
export function categorize(desc, overrides = {}) {
  ...
  // Cannabis
  if (d.includes("POT SPOT") || d.includes("VALUEBUD") || d.includes("CANNABIS") || d.includes("CANNA") || d.includes("DISPENSARY") || d.includes("OCS ") || d.includes("SPIRITLEAF") || d.includes("TWEED") || d.includes("TOKYO SMOKE") || d.includes("MISC CANNABIS")) return "Cannabis";

  // Food delivery
  if (d.includes("UBER EATS") || d.includes("DOORDASH") || d.includes("DASHPASS") || d.includes("SKIP")) return "Food Delivery";

  // Dining & drinks
  if (d.includes("RESTAURANT") || d.includes("CAFE") || d.includes("COFFEE") || d.includes("ESPRESSO") || d.includes("BAKERY") || d.includes("PASTA") || d.includes("SUSHI") || d.includes("GRILL") || d.includes("BISTRO") || d.includes("BREWERY") || d.includes("PIZZA") || d.includes("ICE CREAM") || d.includes("TIM HORTON") || d.includes("STARBUCKS") || d.includes("NOVA ERA") || d.includes("POUR BOY") || d.includes("NORTH OF BROOKLYN") || d.includes("GOOD BEHAVIOUR") || d.includes("WASTED YOUTH") || d.includes("SOVEREIGN") || d.includes("ALMOND BUTTERFLY") || d.includes("LCBO") || d.includes("SAUCY") || d.includes("KIIN") || d.includes("PIZZERIA") || d.includes("BAZAAR") || d.includes("CRAFTY COYOTE") || d.includes("SUNNYS CHINESE") || d.includes("THREE SPEED") || d.includes("ANNEX SOCIAL") || d.includes("CORNER PLACE") || d.includes("RIVOLI") || d.includes("DARK HORSE") || d.includes("ANNABELLE PASTA") || d.includes("GAUCHO") || d.includes("WYCH") || d.includes("AD HOSPITALITY") || d.includes("BANG BANG") || d.includes("TINY MARKET") || d.includes("GREATER GOOD") || d.includes("CHAHALO") || d.includes("ERIKA KULLBERG") || d.includes("FAMIGLIA")) return "Dining & Drinks";

  // Groceries
  if (d.includes("GROCERY") || d.includes("WALMART") || d.includes("SOBEYS") || d.includes("LOBLAWS") || d.includes("FRESHCO") || d.includes("FORTINOS") || d.includes("NO FRILLS") || d.includes("FARM BOY") || d.includes("FOTO GROCERY") || d.includes("T&T SUPERMARKET") || d.includes("METRO") || d.includes("HMART") || d.includes("H MART") || d.includes("RABBA")) return "Groceries";

  // Transit & rideshare
  if (d.includes("UBER ") || d.includes("LYFT") || d.includes("PRESTO") || d.includes("GO TRAIN") || d.includes("FREENOW") || d.includes("BOLT SERVICES")) return "Transit & Rideshare";

  // Travel
  if (d.includes("FLIGHT") || d.includes("AIR CANADA") || d.includes("WESTJET") || d.includes("JETBLUE") || d.includes("EMIRATES") || d.includes("TRIP.COM") || d.includes("TRAINLINE") || d.includes("FLIXBUS") || d.includes("HEATHROW") || d.includes("EXPEDIA") || d.includes("BOOKING.COM")) return "Travel - Flights";
  if (d.includes("HOTEL") || d.includes("MARRIOTT") || d.includes("HILTON") || d.includes("AIRBNB") || d.includes("VRBO")) return "Travel - Hotels";

  // Entertainment & events
  if (d.includes("TICKETMASTER") || d.includes("POINTS DEVELOPMENT") || d.includes("FANTASY FOOTBALL") || d.includes("USCUSTOMS TRUSTED") || d.includes("UKVI") || d.includes("P1. CORPORATE")) return "Entertainment & Events";

  // Subscriptions
  if (d.includes("NETFLIX") || d.includes("SPOTIFY") || d.includes("APPLE") || d.includes("GOOGLE") || d.includes("DISNEY") || d.includes("CRAVE") || d.includes("YOUTUBE") || d.includes("WILLOW.TV") || d.includes("RAZORPAY") || d.includes("BILLDESK") || d.includes("HINGE") || d.includes("PUREVPN") || d.includes("FUBOTV") || d.includes("WALMART DELIVERY") || d.includes("CRUNCHYROLL") || d.includes("IMPRINT")) return "Subscriptions & Apps";

  // Shopping
  if (d.includes("AMAZON") || d.includes("AMZN") || d.includes("BEST BUY") || d.includes("COSTCO") || d.includes("IKEA") || d.includes("UNIQLO") || d.includes("TEMU") || d.includes("DOLLAR BAZAAR") || d.includes("DOLLARAMA") || d.includes("TSHIRT GUYS") || d.includes("MAX RETAIL")) return "Shopping";

  // Health & wellness
  if (d.includes("SHAPE FITNESS") || d.includes("CHIROPATH") || d.includes("ACHES AWAY") || d.includes("ORIGIN WELLNESS") || d.includes("BLOOR FOOT") || d.includes("REXALL") || d.includes("PHARMACY") || d.includes("MEDICAL") || d.includes("DENTAL") || d.includes("LIFEHETU") || d.includes("RAZ*LIFEHETU")) return "Health & Wellness";

  // Bills & utilities
  if (d.includes("FIDO") || d.includes("ROGERS") || d.includes("KOODO") || d.includes("BELL ") || d.includes("TELUS") || d.includes("HYDRO") || d.includes("ENBRIDGE") || d.includes("SQUARE ONE INSURANCE")) return "Bills & Utilities";
